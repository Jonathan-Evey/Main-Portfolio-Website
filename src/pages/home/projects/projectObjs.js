	...
	smallProjects: [
		{
			...
			description: [
				...
				"Site uses vanilla JS to create the differant pages within the restaurant website, and controlls all user interations.",
				"Design and layout was created by me, with styling done using base CSS.",
