  ...
  return (
    <section className="section hero" ref={ref}>
      ...
      <div className="hero container">
        ...
        <p className="fs-500 margin-block-32">Hello and welcome! I am a self taught developer that started out in front end development and am working towards becoming proficient as a full stack developer. My language skill set currently includes JavaScript, React, CSS and SASS.</p>
